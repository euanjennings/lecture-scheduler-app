...
public class RemoveLectureView extends Stage implements ClientView {
    ...
    private void setupButtonAction(Button sendButton, DatePicker datePicker, 
        ...
        sendButton.setOnAction(e -> {
            ...
            String response = controller.handleRequest("Remove", dateFormatter.format(date), time, room, module);
